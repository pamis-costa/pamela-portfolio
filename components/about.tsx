...
export default function About() {
  const { ref } = useSectionInView("Sobre Mim", 0.3);
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        estou completando meu aprendizado com bootcamps e cursos intensivos e
        técnicos. Sou movida pela curiosidade, então estou
      ...
      <p>
        ...
        relaxar passeando com meus amigos, enchendo todos os <span className="font-bold">gatinhos</span> de carinho 🐈‍ e assistindo a muitos{" "}
        <span className="font-bold">filmes de Bollywood</span> 🎬 (uma paixão
        pessoal rsrs!). Continuo sendo uma curiosa sobre{" "}
        <span className="font-bold">biologia e ciência</span> em geral, e nas
        horas vagas, gosto de tocar <span className="font-bold">teclado</span> ouvindo muito rock. 🤘
      </p>
    </motion.section>
  );
}
